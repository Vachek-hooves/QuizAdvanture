...
import CustomeWelcome from './Target/CustomeWelcome';
  ...
  useEffect(() => {
    const initializeApp = async () => {
      ...
      try {
        ...
        await initAppsFlyer();
        // console.log('check is was app visited');
        // const wasAppVisit = await isWasAppVisited();
        // console.log('Was app visited before:', wasAppVisit);

        // if (!wasAppVisit) {
        //   console.log('app was NOT visited');
        //   await initAppsFlyer();
        // } else {
